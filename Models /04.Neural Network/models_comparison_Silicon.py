...
plt.title("Machine Learning Model Comparison (Ln(V₀) of Silicon)", fontsize=16, weight='bold')
plt.ylabel("Score / Error", fontsize=13)
plt.xlabel("")
plt.xticks(rotation=15)
plt.legend(title="Metric", fontsize=12, title_fontsize=13)
plt.tight_layout()
plt.savefig("model_comparison_LnV0_Silicon.png", dpi=600, bbox_inches="tight")
plt.show()
